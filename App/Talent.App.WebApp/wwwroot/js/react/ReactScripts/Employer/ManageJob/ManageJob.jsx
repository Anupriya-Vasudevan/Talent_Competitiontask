    ...
    loadData(callback) {
       ...
       $.ajax({
        ...
        success: function (res) {
            this.setState({loadJobs: res.myJobs},callback)
            console.log(res);
           // callback();
        }.bind(this),
        error: function (res) {
            ...
            <BodyWrapper reload={this.init} loaderData={this.state.loaderData}>
               ...
               <Form>
                <Form.Group inline>
                            ...
                            {"Sort by date: "}
                            <Dropdown inline simple options={sortOptions}  name="date"  onChange={this.handleSortChange}
                    ...
                    <Card.Group>
                    {
                        ...
                        ? loadJobs.map(job => {
                            return (
                                <JobSummaryCard key={job.id} job={job} reloadData={this.loadData}/>
                            )
                        })
                         : 'No Jobs Found'
                    }
